...
from .views import AnnualSalesTotal, DailySalesTotal, MonthlySalesTotal, UpdateOrderStatus, VendorAllOrder, VendorArrivedOrder, VendorOrder, VendorShippedOrder, add_to_cart

urlpatterns = [
    path("add-to-cart/",add_to_cart, name="add_to_cart"),
    path('new-orders/', VendorOrder.as_view(),name="vendor_orders"),
